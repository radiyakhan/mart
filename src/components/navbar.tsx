...
const Navbar = () => {
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center text-red-800">
      ...
      <Link href={"#"} className="mr-5 ml-5 hover:text-white">SHOP</Link>
      <Link href={"#"} className="mr-5 ml-5 hover:text-white" >FEATURES</Link>
      <Link href={"#"} className="mr-5 ml-5 hover:text-white">CONTACT</Link>
    </nav>
